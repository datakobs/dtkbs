function readConfig(t) {
  ...
  if (!e) return null
  var n,
    i = ((n = (e.textContent || e.innerHTML).replace(/^\s+|\s+$/gm, "")),
    String(n)
      .replace(/&quot;/g, '"')
      .replace(/&#39;/g, "'")
      .replace(/&#x2F;/g, "https://stripe.com/")
      .replace(/&lt;/g, "<")
      .replace(/&gt;/g, ">")
      .replace(/&amp;/g, "&"))
  return /^[\],:{}\s]*$/.test(
...
function globalNavDropdowns(t) {
  ...
  if (
    ...
    !this.container.classList.contains("no-dropdown"))
  ) {
    ...
    ;(this.keyDownHandler = null),
      this.dropdownRoots.forEach(function(t, i) {
...
function globalNavPopup(t) {
  ...
  ;(this.activeClass = "globalPopupActive"),
    ...
    this.root &&
      ...
      this.closeButton &&
        this.closeButton.addEventListener(n, function(t) {
          e.closeAllPopups()
        }),
...
!(function() {
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ;(t = document.querySelector('[rel="cookie-notification"]')),
      (e = document.querySelector('[rel="dismiss-cookie-notification"]')) &&
  ...
  window.$ &&
    ...
    $(function() {
      ...
      return (
        (t = function() {
          var t, e
          return (t = $("form input[name=csrf-token]")).length > 0
            ? t.attr("value")
            : (e = $("meta[name=csrf-token]")).length > 0
            ? e.attr("content")
            : ""
        }),
  ...
  (Strut.load = {
    ...
    js: function(t, e) {
      ...
      if (!i)
        throw new Error(
          'Javascript file "' + t + '" not found in strut_files config'
        )
      ;(n.src = i),
        (n.async = !1),
        document.head.appendChild(n),
  ...
  (globalNavDropdowns.prototype.checkCollision = function() {
    if (!Strut.isMobileViewport)
      if (1 == this.compact) {
        ...
        e.left + e.width / 2 > t / 2 &&
          (this.container.classList.remove("compact"), (this.compact = !1))
      } else {
        var n = this.primaryNavItem.getBoundingClientRect(),
          i = this.secondaryNavItem.getBoundingClientRect()
        n.right > i.left &&
          (this.container.classList.add("compact"), (this.compact = !0))
      }
  }),
  (globalNavDropdowns.prototype.registerArrowKeyNavigation = function(t, e) {
    ...
    i[o].focus(),
      (this.keyDownHandler = function(e) {
        9 === e.keyCode
          ? (t.focus(), n.startCloseTimeout())
          : 38 === e.keyCode
          ? (e.preventDefault(), --o < 0 && (o += i.length), i[o].focus())
          : 40 === e.keyCode &&
            (e.preventDefault(),
  ...
  (globalNavDropdowns.prototype.openDropdown = function(t, e) {
    ...
    if (this.activeDropdown !== t) {
        ...
        c.el.classList.remove("active"),
          ...
          c.name == r
            ? (c.el.setAttribute("aria-hidden", "false"),
              ...
              (s = "right"),
              (i = c.content.offsetWidth),
              (o = c.content.offsetHeight),
              c.content.getAttribute("data-fixed")
                ? c.content.setAttribute("data-fixed", !0)
                : ((c.content.style.width = i + "px"),
                  (c.content.style.height = o + "px")),
              (a = c.content),
              e &&
                e.keyboardNavigation &&
                n.registerArrowKeyNavigation(t, c.el))
            : (c.el.classList.add(s), c.el.setAttribute("aria-hidden", "true"))
      })
      var c = i / 380,
        d = o / 400,
        l = t.getBoundingClientRect(),
        u = l.left + l.width / 2 - i / 2
      ;(u = Math.round(Math.max(u, 10))),
        clearTimeout(this.disableTransitionTimeout),
        (this.enableTransitionTimeout = setTimeout(function() {
          n.container.classList.remove("noDropdownTransition")
        }, 50)),
        (this.dropdownBackground.style.transform =
          "translateX(" + u + "px) scaleX(" + c + ") scaleY(" + d + ")"),
        (this.dropdownContainer.style.transform = "translateX(" + u + "px)"),
      ...
      this.dropdownArrow.style.transform =
        "translateX(" + w + "px) rotate(45deg)"
      var p = a.children[0].offsetHeight / d
      ;(this.dropdownBackgroundAlt.style.transform = "translateY(" + p + "px)"),
        window.siteAnalytics &&
          window.siteAnalytics.trackGlobalNavDropdownOpen &&
          window.siteAnalytics.trackGlobalNavDropdownOpen(r)
    }
  }),
  ...
  (globalNavPopup.prototype.togglePopup = function() {
    ...
    this.closeAllPopups(!0),
      t || (this.root.classList.add(this.activeClass), (this.isOpening = !0))
  }),
  (globalNavPopup.prototype.closeAllPopups = function(t) {
    for (
      var e = document.getElementsByClassName(this.activeClass), n = 0;
      n < e.length;
      n++
    )
  ...
  Strut.supports.pointerEvents ||
    Strut.load.css("https://stripe.com/v3/shared/navigation_ie10.css"),
  ...
  (function() {
    ...
    function k() {
      ;(t = null),
        window.Analytics
          ? (s("Flushing event queue"),
            A(),
            i.forEach(function(t) {
              h.apply(this, t)
            }),
            (a = o))
          : (b(), s("Ready timer waiting " + a + "ms"))
    }
    function C(t) {
      if (!window.ga)
        return (
          (window.siteAnalyticsUtil.enqueuedCalls =
            window.siteAnalyticsUtil.enqueuedCalls || []),
    ...
    function S() {
      window.ga && window.siteAnalyticsUtil.generalAnalyticsConfig
        ? window.siteAnalyticsUtil.enqueuedCalls &&
          (window.siteAnalyticsUtil.enqueuedCalls.forEach(function(t) {
            var e = window.siteAnalyticsUtil[t.fnName]
            e
              ? e.apply(window.siteAnalyticsUtil, t.args)
              : setTimeout(function() {
    ...
    window.siteAnalyticsUtil.analyticsConfigData ||
      (v(),
      b(),
      ...
      (window.siteAnalyticsUtil.siteAnalyticsConfig = l),
      ...
      (window.siteAnalyticsUtil.generalAnalyticsConfig = d),
      S())
  })(),
  (function() {
    ...
    function o(e) {
      return e && e.getAttribute
        ? e.getAttribute(t) || e.getAttribute(n)
          ? e
          : e.parentNode && "BODY" !== e.tagName
          ? o(e.parentNode)
          : null
        : (setTimeout(function() {
            window.Raven &&
              window.Raven.captureMessage(
                "Tried to findAnalyticsAttributes on something without .getAttribute (old code)",
                { extra: { el: e } }
              )
          }, 2e3),
          null)
    ...
    function r(a) {
      var r = (function(a) {
        var r = o(a),
          s = {}
        return (
          r.getAttribute(t) && (s.action = r.getAttribute(t)),
          r.getAttribute(n) && (s.modal = r.getAttribute(n)),
          r.getAttribute(e) && (s.params = { source: r.getAttribute(e) }),
          r.getAttribute(i) &&
            (s.googleAnalyticsParams = JSON.parse(r.getAttribute(i))),
          r.getAttribute(e) &&
            -1 !== r.getAttribute(e).indexOf("cta") &&
            (s.trackCta = !0),
          s
        )
      })(a)
  ...
  (function() {
    ...
    function s(t) {
      window.fbq &&
        t &&
        (window.fbq("track", t),
        window.siteAnalyticsUtil.debugActive() && console.log("FB track", t))
    }
    ;(t = window),
      (e = document),
      (n = "script"),
      t.fbq ||
        ...
        (i.version = "2.0"),
        (i.queue = []),
        ((o = e.createElement(n)).async = !0),
        (o.src = "https://connect.facebook.net/en_US/fbevents.js"),
        (a = e.getElementsByTagName(n)[0]).parentNode.insertBefore(o, a)),
      window.fbq && window.fbq("init", r),
      (window.siteAnalytics.trackFacebookEvent = s),
      s("PageView")
  })(),
  (function() {
    function t(t) {
    ...
    document.addEventListener("DOMContentLoaded", function() {
      ;[].slice
        .call(document.querySelectorAll(".languagePicker a[data-language]"))
        .forEach(function(e) {
          e.addEventListener("click", t)
        }),
        [].slice
          .call(document.querySelectorAll(".countryPicker a[data-country]"))
          .forEach(function(t) {
  ...
  (function() {
    ...
    function n(n) {
      e[n] ||
        ((e[n] = !0), window.siteAnalyticsUtil.emitAction(t, { dropdown: n }))
    }
  ...
  (function(t, e, n, i, o) {
    ...
    var a = e.getElementsByTagName(n)[0],
      r = e.createElement(n)
    ;(r.async = !0),
      (r.src = "https://www.googletagmanager.com/gtm.js?id=GTM-W8NSNKQ"),
  ...
  (function() {
    ...
    function y(t) {
      ...
      d[e] || ((d[e] = !0), window.siteAnalyticsUtil.emitAction(n, { text: e }))
    }
    function m(t) {
      var e = t.innerText.trim().toLowerCase()
      l[e] || ((d[e] = !0), window.siteAnalyticsUtil.emitAction(i, { text: e }))
    }
    function h(t) {
      var e = t.innerText.trim().toLowerCase()
      u[e] || ((u[e] = !0), window.siteAnalyticsUtil.emitAction(o, { text: e }))
    }
    function v(t, e) {
      var n = t.dataset.nodeType,
        i = t.dataset.nodeDescription,
        o = t
          .querySelector(".infra-node__meta")
          .textContent.trim()
          .toLowerCase(),
        r = e + "-" + n + "-" + o
      w[r] ||
    ...
    function A(t) {
      ...
      p[e] ||
        ((p[e] = !0), window.siteAnalyticsUtil.emitAction(r, { section: e }))
    }
    function b(t) {
      window.siteAnalyticsUtil.emitAction(s, { category: t })
    }
    function k(t) {
      window.siteAnalyticsUtil.emitAction(s, { query: t })
    }
    function C() {
    ...
    function i(i) {
      var o,
        a = (function(i) {
          ...
          return /\.pdf$|\.pdf#|\.pdf\?/i.test(i.href)
            ? n
            : -1 !== o.indexOf("button") || "#" === a
            ? e
            : t
        })(i),
        r = { text: ((o = i.innerText), o.trim().replace(/\s+/g, " ")) }
  ...
  (function() {
    function t() {
      if (
        (function() {
          ...
          return !!window.siteAnalyticsUtil.siteAnalyticsConfig()
            .trackPageViewed
        })()
      ) {
    ...
    window.siteAnalytics.pageLoadTracking ||
      ((window.siteAnalytics.pageLoadTracking = { trackPageView: t }),
      ...
      "string" != typeof e &&
        ((n = (function(t) {
          return (
            t.currentSrc ||
            t.getAttribute("src") ||
            t.querySelector("source").getAttribute("src")
          )
        })(e)),
        (o = (i = n.slice(n.lastIndexOf("https://stripe.com/") + 1)).slice(
          0,
          i.lastIndexOf(".")
        ))),
        window.siteAnalyticsUtil.emitAction(t, { video: o })
    }
    function s(t) {
